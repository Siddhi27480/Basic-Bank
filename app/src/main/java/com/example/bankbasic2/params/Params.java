...
public class Params {
    ...
    public static final String SenderBB="s_balance_before";
    public static final String SenderAB="s_balance_after";
    public static final String ReceiverBB="r_balance_before";
    public static final String ReceiverAB="r_balance_after";
